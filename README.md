...
Tests can be found here: [Link](https://github.com/Games-of-Threads/TestEX1-DFH). But it has gained some more tests and updates since last time. The xUnitTests written in C# can be found in the repository or here: [UnitTest1.cs](https://github.com/Games-of-Threads/TestEX2-DFH/blob/master/TriangleTest/TriangleTestingProject/UnitTest1.cs). The actual new triangle class can be found in the repository or [Triangle.cs](https://github.com/Games-of-Threads/TestEX2-DFH/blob/master/TriangleTest/TriangleTest/Triangle.cs)
